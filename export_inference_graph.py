...
flags.DEFINE_string('input_shape', None,
                    ...
                    '`[None, None, None, 3]`.')
flags.DEFINE_string('pipeline_config_path', "Z:/DeepLabCut/misc/tensorflow/coco_project_heads/mask_rcnn_resnet50_atrous_coco.config",
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', "Z:/DeepLabCut/misc/tensorflow/coco_project_heads/models/train/model.ckpt-10534",
                    'Path to trained checkpoint, typically of the form '
                    'path/to/model.ckpt-10534')
flags.DEFINE_string('output_directory', "Z:/DeepLabCut/misc/tensorflow/coco_project_heads/frozen/", 'Path to write outputs.')
